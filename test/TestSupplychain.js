...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        // Declare and Initialize a variable for event
        let sellEventEmitted = false;
        
        // Watch the emitted event ForSale()
        await supplyChain.ForSale(null, (err, res) =>{
            sellEventEmitted = true;
        });
        ...
        assert.equal(sellEventEmitted, true, 'Invalid event emitted');
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // Declare and Initialize a variable for event
        let buyEventEmitted = false;

        // Watch the emitted event Sold()
        await supplyChain.Sold(null, (err, res) =>{
           buyEventEmitted = true;
        });
        ...
        assert.equal(buyEventEmitted, true, 'Invalid event emitted');
    });
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // Mark an item as Shipped by calling the function shipItem()
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        // Mark an item as Purchased by calling purchaseItem()
